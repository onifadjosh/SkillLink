        ...
        <div className="flex gap-3.5 justify-between items-center h-16">
          ...
          <div className="hidden md:flex">
            <div className="flex justify-center items-center gap-6 ">
              <Link to={'/login'} className='bg-blue-500 text-white  hover:rounded-full  hover:bg-blue-600 py-2 px-5 rounded-lg' >Log In</Link>
              <Link to={'/register'} className='border-blue-500 border-2 rounded-lg hover:rounded-full  hover:bg-blue-500 hover:text-white text-dark py-2 px-4 focus:outline-2 focus:outline-offset-2 focus:outline-blue-500 active:bg-blue-700' >Get Started</Link>
